...
<form  class="row" action="/nha-san-xuat/add" method="post">
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" name="id" value="${nsx.id}" disabled>
    </div>
    <div class="col-md-3">
...
<table class="table table-hover">
    ...
    <tbody>
    <c:forEach items="${listNSX}" var="o" varStatus="i">
        <tr>
            <th>${i.index}</th>
            <th>${o.id}</th>
            <th>${o.ma}</th>
            ...
            <td>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/nha-san-xuat/remove/${o.id}">Remove</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/nha-san-xuat/view-update/${o.id}">Update</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/nha-san-xuat/detail/${o.id}">Detail</a>
                </button>
            </td>
        </tr>
    </c:forEach>
