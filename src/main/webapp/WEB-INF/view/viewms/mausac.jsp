...
<form  class="row" action="/mau-sac/add" method="post">
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" name="id" value="${ms.id}" disabled>
    </div>
    <div class="col-md-3">
...
<table class="table table-hover">
    ...
    <tbody>
    <c:forEach items="${listMS}" var="o" varStatus="i">
        <tr>
            <th>${i.index}</th>
            <th>${o.id}</th>
            <th>${o.ma}</th>
            ...
            <td>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/mau-sac/remove/${o.id}">Remove</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/mau-sac/view-update/${o.id}">Update</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/mau-sac/detail/${o.id}">Detail</a>
                </button>
            </td>
        </tr>
    </c:forEach>
