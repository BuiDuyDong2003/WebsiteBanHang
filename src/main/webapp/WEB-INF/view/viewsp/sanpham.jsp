...
<body>
<form  class="row" action="/san-pham/add" method="post">
    <div class="col-md-3">
...
<table class="table table-hover">
    ...
    <tbody>
    <c:forEach items="${listSP}" var="o" varStatus="i">
        <tr>
            <th>${i.index}</th>
            <th>${o.id}</th>
            <th>${o.ma}</th>
            ...
            <td>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/san-pham/remove/${o.id}">Remove</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/san-pham/view-update/${o.id}">Update</a>
                </button>
                <button class="btn btn-outline-success"><a style="text-decoration: none"
                                                           href="/san-pham/detail/${o.id}">Detail</a>
                </button>
            </td>
        </tr>
    </c:forEach>
